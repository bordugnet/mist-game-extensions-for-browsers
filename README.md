...
Кнопка (![alt text]([image-9.png](https://www.mediafire.com/view/7i4eqwrwegx4ojp/mist-demo.gif/file))) включает/отключает звук если персонаж нашел находку (для ввода каптчи или взаимодействия с НПС), кнопка <img width="34" height="29" alt="image" src="https://github.com/user-attachments/assets/a42dc3a9-def7-40bc-b88f-8f0f6642fe3e" />
